...
from training.dataset import TensorDataset
...
# @click.option('--data_multiplier',         help='Enable dataset x-flips', metavar='FLOAT', type=float, default=False, show_default=True)
...
def main(**kwargs):
    ...
    c = dnnlib.EasyDict()
    c.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.TensorDataset', path=opts.data, use_labels=opts.cond, xflip=opts.xflip, cache=opts.cache, )
